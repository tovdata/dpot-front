...
export function ProvisionTable() {
  ...
  // Return an element
  return (<EditableTableForm dataSource={data} expandKey='isForeign' headers={provisionTableHeader} innerHeaders={expandProvisionTableHeader} onAdd={onAdd} onDelete={onDelete} onSave={onSave} rawSelectOptions={{}} title='개인정보 제공'  />);
};
...
export function ConsignmentTable() {
  ...
  return (<EditableTableForm dataSource={data} headers={consignmentTableHeader} onAdd={onAdd} onDelete={onDelete} onSave={onSave} rawSelectOptions={{}} title='개인정보 위탁' />)
}