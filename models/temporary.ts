// Type
import { FalseNameInformationDF, PersonalInformationDF, ProcessingItemDF } from './type';
...
export const personalInfo: PersonalInformationDF[] = [{
  ...
  selectionItems: ["휴대전화번호", "생년월일", "회원가입 및 관리"],
  subject: "회원가입 및 관리",
  uuid: "1"
}, {
  basisOfCollection: ["통신비밀보호법", "전자금융거래법"],
...
// 처리 항목
export const processingItems: string[] = ["이름", "아이디"];
